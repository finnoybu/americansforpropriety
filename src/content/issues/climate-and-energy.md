...
facts:
  ...
  - "The Inflation Reduction Act's clean-energy tax credits spurred a surge in private investment, though projected totals have narrowed since the 2025 OBBBA rollback of those credits."
subtopics:
...
keyBills:
  - name: "Inflation Reduction Act (clean energy provisions)"
    ...
    status: "Enacted Aug 2022; clean-energy credits rolled back by OBBBA (July 2025) — EV credits ended Sept 2025, wind/solar credits phasing out"
  ...
  - name: "BUILDER Act / permitting reform"
    ...
    status: "Partial enactment in FY24 NDAA; SPEED Act passed House Dec 2025, stalled in Senate"
  - name: "Methane Emissions Reduction Program"
    chamber: "federal"
    summary: "IRA-funded waste emissions charge on methane from oil and gas operations above a threshold; would have been the first US federal price on a greenhouse gas."
    status: "Neutralized in two steps in 2025: a CRA disapproval (P.L. 119-2, March 2025) struck the EPA implementing rule, then OBBBA (July 2025) amended Clean Air Act §136 to delay the charge to 2034. Never took effect; statute not formally repealed."
...
timeline:
  ...
  - date: "2024"
    event: "First major IRA-funded clean energy facilities come online."
  - date: "2025"
    event: "A CRA disapproval (March) strikes the EPA rule implementing the IRA methane charge; OBBBA (July) then amends Clean Air Act §136 to delay the charge to 2034 — it never takes effect. OBBBA also rolls back the IRA's clean-energy tax credits, ending EV credits and phasing out wind and solar credits. Insurance-market withdrawal accelerates in CA, FL, LA."
  - date: "2026"
    event: "EPA finalizes rescission of the CO2 endangerment finding (February). Courts enjoin a set of federal offshore-wind and clean-energy permitting actions."
relatedBriefs: []
relatedLetters: []
relatedActions: []
---
