---
title: "To a state legislator: support climate resilience and insurance reform"
summary: "Insurance retreat from climate-exposed zones is a state-level fight. Most state legislatures are now actively reforming their insurance markets."
...
1. **Insurance market reforms** that allow insurers to use forward-looking catastrophe modeling in rate-setting, paired with anti-redlining provisions that require insurers writing in low-risk zones to also write in higher-risk zones in proportion to their statewide market share.

2. **Building code modernization** for climate resilience, particularly in new construction. The state-level Building Code Effectiveness Grading Schedule provides a measurable framework.

3. **State catastrophe-pool funding** to ensure that state insurers of last resort are adequately capitalized and can manage the increased exposure they're absorbing.

4. **Managed retreat programs** for repeatedly damaged properties, with structured buyouts that don't depend on the federal-flood-insurance dynamic.

5. **Climate disclosure for major property purchases** that gives buyers meaningful information about climate-related risk before they commit to long-term financial exposure.
