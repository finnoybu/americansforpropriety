---
title: "To a US Senator: support the Better Care Better Jobs Act"
...
1. **Substantial federal HCBS funding** with conditions on state implementation, addressing the waiting-list crisis directly.

2. **Direct-care worker wage standards** conditioned on the funding. The workforce shortage that constrains HCBS access is directly tied to wages well below livable-wage thresholds in many states; federal wage floors would address it.

3. **Mandatory state HCBS plans** with waiting-list reduction targets and accountability measures.

4. **Expanded supported-employment funding** for disabled workers in competitive integrated employment.

5. **Money Follows the Person reauthorization** at expanded scale, supporting transitions from institutional to community settings.
